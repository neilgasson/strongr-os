...
**M2.2 implementation — governed review and private release staging**
...
at `a07a258db216309d7667a9a8f52fdd6c966b492f`, and accepted M2.1 through PR
#21 at `9bae01e039e575c5a2e7eb6308d680a6586eb96c`. M2.2 adds exact private
artifact retrieval, append-only human media/accessibility review, AAL2 release
staging and revocation, and immutable staged manifests. Recovery acceptance,
...
scope, M2.0 and M2.1 are complete, and M2.2 governed review and private release
staging is in progress. That approval does
